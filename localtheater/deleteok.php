	    ...
	    <div class="panel-body">
			<div class="row">		
				...
				<div class="col-md-12 col-sm-12 already-registered-login">
					<h2 style="color: #5AF891">Delete Your Account?</h2>
					<button onclick="document.location = 'delete.php'">OK</button>
					<button onclick="document.location = 'my-account.php'">Cancel</button>
