  ...
  <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span> Manage Admins </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
    ...
    <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="manage-users.php">Edit/delete Users</a></li>
                                </ul>
                            </li> 
