...
if($_GET['resid'])
{
	...
	$msg="User details are restored successfully";
}
...
if($_GET['action']=='parmdel' && $_GET['rid'])
{
	...
	$delmsg="Users details are delelted forever";
}
...
body {
  ...
  background-size: cover;
        ...
        <title> LOCAL THEATER| Manage Users</title>
...
<button id="addToTable" class="btn btn-success waves-effect waves-light">Add <i class="mdi mdi-plus-circle-outline" ></i></button>
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select id,name,email,contactno from  users where Is_Active=1");
$cnt=1;
...
<td><a href="edit-users.php?uid=<?php echo htmlentities($row['id']);?>"><i class="fa fa-pencil" style="color: #29b6f6;"></i></a> 
...
<table class="table m-0 table-colored-bordered table-bordered-danger">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select id,name,email,contactno from  users where Is_Active=0");
$cnt=1;
while($row=mysqli_fetch_array($query))
{
?>
